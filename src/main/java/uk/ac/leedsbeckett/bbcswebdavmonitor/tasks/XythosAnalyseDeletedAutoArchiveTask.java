...
public class XythosAnalyseDeletedAutoArchiveTask extends BaseTask
{
  ...
  public void doTask() throws InterruptedException
  {
    ...
    Path logfile = bbmonitor.logbase.resolve( "deletedautoarchiveanalysis-" + bbmonitor.dateformatforfilenames.format( new Date(System.currentTimeMillis() ) ) + ".txt" );
    ...
    {
      bbmonitor.logger.error( "Error processing Xythos files.", ex);
    }
